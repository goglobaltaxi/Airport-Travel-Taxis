...
export const metadata: Metadata = {
    title: 'Taxi from Riyadh Airport to Qatar Border | Book Online',
    description: 'Book a professional taxi from Riyadh Airport to Qatar Border. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
    openGraph: {
        title: 'Taxi from Riyadh Airport to Qatar Border | Book Online',
        description: 'Book a professional taxi from Riyadh Airport to Qatar Border. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
        url: 'https://airporttraveltaxis.com/taxi-from-riyadh-airport-to-qatar-border',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/taxi-from-riyadh-airport-to-qatar-border',
    },
};
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Taxi from Riyadh Airport to Qatar Border</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h1 className="font-display text-4xl lg:text-5xl text-surface-900 mb-6 leading-tight">
                                Taxi from Riyadh Airport to Qatar Border
                            </h1>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8">
                                ...
                                <p className="text-surface-700 leading-relaxed">
                                    Arriving at King Khalid International Airport (RUH) in Riyadh and continuing by road to Qatar requires a significant transit. Our pre-booked cross-border transfer connects you directly to the Salwa border.
                                </p>
                            </div>
                            <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8">
                                <h2 className="font-display text-2xl text-surface-900 mb-4 flex items-center gap-2">
                                ...
                                <p className="text-surface-700 leading-relaxed">
                                    Our driver meets you at the arrivals section of Riyadh Airport. Following luggage collection, you are led to the vehicle. This must be scheduled in advance; street taxis are not available for this specialized long-distance route.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="border border-surface-200 rounded-2xl p-8">
                                ...
                                <p className="text-surface-600 leading-relaxed">
                                    At the Salwa border, you must present your Saudi exit documents and Qatari entry documents. Your driver will manage vehicle and travel logistics at the checkpoint.
                                </p>
                            </div>
                            <div className="border border-surface-200 rounded-2xl p-8">
                                <h3 className="font-display text-2xl text-surface-900 mb-4 flex items-center gap-2">
                                ...
                                <p className="text-surface-600 leading-relaxed">
                                    The distance from Riyadh Airport to the Salwa border is about 460 kilometers. Standard travel time is roughly 4.5 to 5 hours along the main highway.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="bg-primary-900 rounded-[32px] p-8 md:p-12 text-white shadow-xl">
                        ...
                        <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-6">
                            {["Book early, ensuring your flight arrival matches the vehicle readiness time.","Ensure your documents permit land border crossing into Qatar.","Coordinate directly with your driver if there are significant flight delays."].map((tip, i) => (
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"Is this an on-demand taxi service?","answer":"No, all transfers must be pre-booked ahead of your flight."},{"question":"What vehicles are suitable for this long drive?","answer":"We offer comfortable sedans, SUVs, and passenger vans suitable for extended driving."},{"question":"Are there stops along the way?","answer":"Yes, the driver can accommodate reasonable rest stops along the highway."}]} title="Frequently Asked Questions" />
                </div>
            </section>
