...
export async function generateStaticParams() {
    return attractionPages.map((page) => ({ slug: page.slug }));
}

export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
    const page = attractionPages.find((p) => p.slug === params.slug);
    if (!page) return {};
    
    const pageTitle = `Taxi to ${page.attractionName} in ${page.city} | Professional Service`;
    const pageDescription = `Book a professional taxi to ${page.attractionName} in ${page.city}. We provide safe, pre-booked 24/7 transportation with professional chauffeurs for sightseeing.`;
    ...
    return {
        ...
        openGraph: {
            title: pageTitle,
            description: pageDescription,
            url: `https://airporttraveltaxis.com/taxi-to-attraction/${page.slug}`,
        },
        alternates: {
            canonical: `https://airporttraveltaxis.com/taxi-to-attraction/${page.slug}`,
        },
    };
}

export default function AttractionTaxiPage({ params }: { params: { slug: string } }) {
    const page = attractionPages.find((p) => p.slug === params.slug);
    if (!page) notFound();

    const vehicles = [
        { name: 'Mercedes S-Class', type: 'Executive Sedan', desc: `Executive comfort for families visiting ${page.attractionName}.` },
        { name: 'BMW', type: 'Executive Sedan', desc: 'Elegant and professional travel for entertainment trips.' },
        { name: 'Genesis', type: 'Executive Sedan', desc: `Refined comfort for your visit to ${page.attractionName} in ${page.city}.` },
        { name: 'Cadillac Escalade', type: 'Large SUV', desc: 'Spacious and executive SUV for tourist groups and families.' },
        { name: 'GMC', type: 'Large SUV', desc: `Ideal for large families visiting ${page.attractionName}.` },
        { name: 'Ford Taurus', type: 'Standard Sedan', desc: 'Reliable city car for attraction visits and sightseeing.' },
        { name: 'Mercedes Vito', type: 'Passenger Van', desc: 'Up to 8 passengers in an executive van setting.' },
        { name: 'Mercedes Sprinter', type: 'Minibus', desc: 'Perfect for larger tourist groups and family outings.' },
        { name: 'Executive Bus', type: 'Coach', desc: `Large group transport for excursions to ${page.attractionName}.` },
        { name: 'Camry', type: 'Standard Sedan', desc: 'Comfortable and efficient for daily leisure trips.' },
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6">
                        ...
                        <span>/</span>
                        <span className="text-surface-900">Taxi to {page.attractionName}</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {['Theme Park', 'Family Attraction', 'Leisure', 'Airport Transfer', 'Hotel Pickup', 'Group Travel'].map((tag) => (
            ...
            <section className="section-padding bg-white">
                <div className="container-custom mx-auto">
                    ...
                    <p className="text-surface-500 mb-8">Discover why {page.attractionName} is a top entertainment destination in {page.city}.</p>
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto">
                    ...
                    <p className="text-surface-500 mb-8">
                        We provide reliable transportation to {page.attractionName} from any location in the city.
                    </p>
                        ...
                        {[
                            {
                                ...
                                desc: `Direct transfers for tourists arriving by air directly to the entertainment zone.`,
                            },
                            {
                                icon: Building2,
                                title: 'Hotel Collection',
                                desc: `Pickups from all major hotels, resorts, and tourist apartments.`,
                            },
                            {
                                icon: Home,
                                title: 'Home or Residence',
                                desc: `Safe and reliable door-to-door service from your residential address.`,
                            },
                            {
                                icon: Map,
                                title: 'City Centers',
                                desc: `Pickup from central districts, shopping malls, or other city landmarks.`,
                            },
                    ...
                    <div className="bg-primary-50 border border-primary-200 rounded-xl p-6 flex flex-col items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-surface-600 text-sm leading-relaxed">
                                Travel time to {page.attractionName} depends on your pickup point in {page.city} and current road traffic. We suggest arriving early, especially on weekends and holidays.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto">
                    ...
                    <p className="text-surface-500 mb-8">
                        Our diverse fleet accommodates all group sizes and family needs for theme park travel.
                    </p>
            ...
            <section className="section-padding bg-white">
                <div className="container-custom mx-auto max-w-3xl">
                    ...
                    <p className="text-surface-500 mb-8">Maximize your entertainment experience with these practical travel tips.</p>
