...
export const metadata: Metadata = {
    title: 'Taxi from Kuwait City to Riyadh | Book Online',
    description: 'Book a professional taxi from Kuwait City to Riyadh. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
    openGraph: {
        title: 'Taxi from Kuwait City to Riyadh | Book Online',
        description: 'Book a professional taxi from Kuwait City to Riyadh. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
        url: 'https://airporttraveltaxis.com/taxi-from-kuwait-city-to-riyadh',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/taxi-from-kuwait-city-to-riyadh',
    },
};
        ...
        <div className="pt-20">
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Taxi from Kuwait City to Riyadh</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h1 className="font-display text-4xl lg:text-5xl text-surface-900 mb-6 leading-tight">
                                Taxi from Kuwait City to Riyadh
                            </h1>
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-8">
                                <div className="bg-white border border-surface-200 rounded-2xl p-5 shadow-sm">
                                    ...
                                    <p className="text-surface-900 font-semibold">900 km</p>
                                </div>
                                <div className="bg-white border border-surface-200 rounded-2xl p-5 shadow-sm">
                                    ...
                                    <p className="text-surface-900 font-semibold">9 to 11 hours</p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="container-custom mx-auto max-w-5xl">
                    <div className="grid md:grid-cols-2 gap-8 mb-8">
                        <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8">
                            ...
                            <p className="text-surface-700 leading-relaxed">The road journey from Kuwait City to Riyadh is a long-distance cross-border transfer through the Nuwaiseeb border crossing. This route is used by business and private travelers preferring road travel between the two cities.</p>
                        </div>
                        <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8">
                            <h2 className="font-display text-2xl text-surface-900 mb-4 flex items-center gap-2">
                            ...
                            <p className="text-surface-700 leading-relaxed">The Nuwaiseeb crossing requires exit from Kuwait and entry into Saudi Arabia. Your driver will navigate both checkpoints while passengers present their passports and valid Saudi entry documents.</p>
                        </div>
                    </div>
                    <div className="border border-surface-200 rounded-2xl p-8">
                        ...
                        <p className="text-surface-600 leading-relaxed">Pickups are arranged from Kuwait City hotels, Kuwait International Airport (KWI), and central commercial areas.</p>
                    </div>
                </div>
            </section>
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="bg-primary-900 rounded-[32px] p-8 md:p-12 text-white shadow-xl">
                        ...
                        <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-6">
                            {["Ensure your Saudi entry visa is valid at the time of travel.","Prepare for a long journey; carry water and essentials.","Coordinate rest stops with your driver in advance."].map((tip, i) => (
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"Is this a direct transfer?","answer":"Yes, the vehicle travels directly from Kuwait City to Riyadh with agreed rest stops."},{"question":"Do you offer local rides within Kuwait?","answer":"No, we only provide pre-booked long-distance and cross-border transfers."},{"question":"Are large group vehicles available?","answer":"Yes, coaches and passenger vans are available for group bookings."}]} title="Frequently Asked Questions" />
                </div>
            </section>
