...
export const metadata: Metadata = {
    title: 'Taxi from Madinah Hotel to Makkah | Book Online',
    description: 'Book a professional taxi from Madinah Hotel to Makkah. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
    openGraph: {
        title: 'Taxi from Madinah Hotel to Makkah | Book Online',
        description: 'Book a professional taxi from Madinah Hotel to Makkah. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
        url: 'https://airporttraveltaxis.com/taxi-from-madinah-hotel-to-makkah',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/taxi-from-madinah-hotel-to-makkah',
    },
};
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Taxi from Madinah Hotel to Makkah</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h1 className="font-display text-4xl lg:text-5xl text-surface-900 mb-6 leading-tight">
                                Taxi from Madinah Hotel to Makkah
                            </h1>
                            ...
                            <p className="text-surface-600 text-lg leading-relaxed mb-8">
                                Travel directly between Madinah and Makkah with a professional, pre-booked driver. This intercity route is designed for pilgrims requiring reliable long-distance transportation.
                            </p>
                        </div>
                ...
                <div className="container-custom mx-auto max-w-5xl">
                    <div className="grid md:grid-cols-2 gap-8 mb-8">
                        ...
                        <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8 h-full">
                            ...
                            <p className="text-surface-700 leading-relaxed">
                                Pilgrims finishing their stay in Madinah and proceeding to Makkah for Umrah or Hajj rituals require a reliable long-distance transfer. We provide pre-booked intercity transportation for this well-traveled pilgrim route.
                            </p>
                        </div>
                        ...
                        <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8 h-full">
                            ...
                            <p className="text-surface-700 leading-relaxed">
                                Your driver will come to your Madinah hotel at the scheduled time. After luggage loading, the vehicle will proceed directly south to Makkah. Booking must be made in advance — ride-hailing apps and short-distance hotel rides are not part of our service.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="border border-surface-200 rounded-2xl p-8">
                        ...
                        <p className="text-surface-600 leading-relaxed md:text-lg">
                            The intercity distance from Madinah to Makkah is around 450 kilometers. The estimated driving time is 4.5 to 5.5 hours on the main highway.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="bg-primary-900 rounded-[32px] p-8 md:p-12 text-white shadow-xl">
                        ...
                        <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-6">
                            {["If performing Umrah, plan your Ihram preparation at the Miqat during the journey.","Communicate any Miqat stop requirement clearly when making your booking.","Schedule an early departure to avoid midday congestion near Makkah entry gates."].map((tip, i) => (
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"Can I stop at the Miqat during this journey?","answer":"Yes, coordinate this requirement when pre-booking and the driver will accommodate the stop."},{"question":"How early should I book this transfer?","answer":"As early as possible, particularly during Ramadan and Hajj season when demand is very high."},{"question":"Do you provide local rides within Madinah?","answer":"No, our service covers only long-distance intercity and airport transfers."}]} title="Frequently Asked Questions" />
                </div>
            </section>
