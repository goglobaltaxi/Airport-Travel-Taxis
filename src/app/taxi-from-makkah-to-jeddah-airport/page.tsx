...
export const metadata: Metadata = {
    title: 'Taxi from Makkah to Jeddah Airport | Book Online',
    description: 'Book a professional taxi from Makkah to Jeddah Airport. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
    openGraph: {
        title: 'Taxi from Makkah to Jeddah Airport | Book Online',
        description: 'Book a professional taxi from Makkah to Jeddah Airport. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
        url: 'https://airporttraveltaxis.com/taxi-from-makkah-to-jeddah-airport',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/taxi-from-makkah-to-jeddah-airport',
    },
};
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Taxi from Makkah to Jeddah Airport</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h1 className="font-display text-4xl lg:text-5xl text-surface-900 mb-6 leading-tight">
                                Taxi from Makkah to <span className="text-primary-600">Jeddah Airport</span>
                            </h1>
                            ...
                            <p className="text-surface-600 text-lg leading-relaxed mb-6">
                                Professional transfer from Makkah to Jeddah Airport. Reliable departure transportation for Umrah pilgrims. Our service ensures a safe, direct, and factual transfer without any hidden surprises.
                            </p>
            ...
            <section className="section-padding bg-white border-y border-surface-200">
                <div className="container-custom mx-auto max-w-4xl text-center">
                    ...
                    <p className="text-surface-600 text-lg leading-relaxed">
                        The journey from Makkah to Jeddah Airport covers approximately 95 km. 
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {["Punctual pickup from your Makkah hotel.","Luggage assistance by the driver.","Direct transfer to the departure terminal at Jeddah Airport.","Assistance unloading luggage at the terminal."].map((step, i) => (
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="bg-white border border-surface-200 rounded-[32px] overflow-hidden shadow-sm">
                        ...
                        <div className="p-8 grid sm:grid-cols-2 gap-6">
                            {["Confirm your departure terminal in advance.","Aim to arrive at the airport well before your flight.","Account for potential Makkah city traffic when scheduling."].map((tip, i) => (
            ...
            <section className="section-padding bg-white">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"How long does the journey take?","answer":"The trip takes approximately 75 to 90 minutes."},{"question":"Can airport drop-off be arranged for Umrah travelers?","answer":"Yes, we specialize in reliable departure transfers."},{"question":"Can groups travel together?","answer":"Yes, our fleet includes options for groups of all sizes."}]} title="Frequently Asked Questions" />
                </div>
            </section>
