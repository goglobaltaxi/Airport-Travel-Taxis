...
export const metadata: Metadata = {
    title: 'Taxi from Saudi Border Nuwaiseeb to Kuwait City | Book Online',
    description: 'Book a professional taxi from Saudi Border Nuwaiseeb to Kuwait City. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
    openGraph: {
        title: 'Taxi from Saudi Border Nuwaiseeb to Kuwait City | Book Online',
        description: 'Book a professional taxi from Saudi Border Nuwaiseeb to Kuwait City. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
        url: 'https://airporttraveltaxis.com/taxi-from-saudi-border-nuwaiseeb-to-kuwait-city',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/taxi-from-saudi-border-nuwaiseeb-to-kuwait-city',
    },
};
        ...
        <div className="pt-20">
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Taxi from Saudi Border (Nuwaiseeb) to Kuwait City</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h1 className="font-display text-4xl lg:text-5xl text-surface-900 mb-6 leading-tight">
                                Taxi from Saudi Border (Nuwaiseeb) to Kuwait City
                            </h1>
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-8">
                                <div className="bg-white border border-surface-200 rounded-2xl p-5 shadow-sm">
                                    ...
                                    <p className="text-surface-900 font-semibold">100 km</p>
                                </div>
                                <div className="bg-white border border-surface-200 rounded-2xl p-5 shadow-sm">
                                    ...
                                    <p className="text-surface-900 font-semibold">1 to 1.5 hours</p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="container-custom mx-auto max-w-5xl">
                    <div className="grid md:grid-cols-2 gap-8 mb-8">
                        <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8">
                            ...
                            <p className="text-surface-700 leading-relaxed">Travelers arriving into Kuwait at the Nuwaiseeb border from Saudi Arabia can arrange a pre-booked transfer to Kuwait City. Our driver meets passengers at the Kuwait entry side of the crossing.</p>
                        </div>
                        <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8">
                            <h2 className="font-display text-2xl text-surface-900 mb-4 flex items-center gap-2">
                            ...
                            <p className="text-surface-700 leading-relaxed">After completing Saudi exit and Kuwaiti entry formalities, your driver will meet you on the Kuwait side of the Nuwaiseeb checkpoint.</p>
                        </div>
                    </div>
                    <div className="border border-surface-200 rounded-2xl p-8">
                        ...
                        <p className="text-surface-600 leading-relaxed">Your pre-booked driver waits at the Kuwait arrivals side of the Nuwaiseeb border. This must be arranged before you reach the border.</p>
                    </div>
                </div>
            </section>
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="bg-primary-900 rounded-[32px] p-8 md:p-12 text-white shadow-xl">
                        ...
                        <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-6">
                            {["Pre-book the transfer prior to your Saudi departure.","Communicate any expected delays due to border processing.","Provide your destination in Kuwait City precisely when booking."].map((tip, i) => (
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"Can the driver meet me at the border?","answer":"Yes, your driver is stationed on the Kuwait side awaiting your entry clearance."},{"question":"Do you offer ride-hailing at the border?","answer":"No, all pickups at the border must be pre-booked exclusively."},{"question":"What if border processing takes longer than expected?","answer":"Your driver will wait for a reasonable time as communicated during booking."}]} title="Frequently Asked Questions" />
                </div>
            </section>
