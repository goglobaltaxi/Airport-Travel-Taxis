...
export const metadata: Metadata = {
    title: 'Taxi from Qatar to Saudi Arabia | Book Online',
    description: 'Book a professional taxi from Qatar to Saudi Arabia. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
    openGraph: {
        title: 'Taxi from Qatar to Saudi Arabia | Book Online',
        description: 'Book a professional taxi from Qatar to Saudi Arabia. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
        url: 'https://airporttraveltaxis.com/taxi-from-qatar-to-saudi-arabia',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/taxi-from-qatar-to-saudi-arabia',
    },
};
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Taxi from Qatar to Saudi Arabia (Salwa Border)</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h1 className="font-display text-4xl lg:text-5xl text-surface-900 mb-6 leading-tight">
                                Taxi from Qatar to Saudi Arabia (Salwa Border)
                            </h1>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8">
                                ...
                                <p className="text-surface-700 leading-relaxed">
                                    Returning or traveling from Qatar to Saudi Arabia is managed through the Abu Samra / Salwa border crossing. We offer organized, pre-booked transportation for travelers heading into the Kingdom.
                                </p>
                            </div>
                            <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8">
                                ...
                                <p className="text-surface-700 leading-relaxed">
                                    Travelers clear Qatari exit immigration before stopping at the Saudi entry point at Salwa. Passports and correct entry visas are rigorously verified.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="border border-surface-200 rounded-2xl p-8">
                                ...
                                <p className="text-surface-600 leading-relaxed">
                                    Pickups are available from Doha, Hamad International Airport (DOH), and various Qatari hotels.
                                </p>
                            </div>
                            <div className="border border-surface-200 rounded-2xl p-8">
                                <h3 className="font-display text-2xl text-surface-900 mb-4 flex items-center gap-2">
                                ...
                                <p className="text-surface-600 leading-relaxed">
                                    The distance from Doha to the border is around 90 kilometers, taking roughly 1 to 1.5 hours. Total journey time depends on your specific destination in Saudi Arabia (e.g., Ahsa, Dammam, Riyadh).
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="bg-primary-900 rounded-[32px] p-8 md:p-12 text-white shadow-xl">
                        ...
                        <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-6">
                            {["Ensure you hold the appropriate documentation to enter Saudi Arabia.","Anticipate standard delays at border checkpoints.","Make your vehicle booking prior to flight arrival if connecting."].map((tip, i) => (
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"Is ad-hoc street taxi travel permitted across the border?","answer":"No, cross-border transfers are heavily regulated and must be pre-booked."},{"question":"Can you transport large luggage?","answer":"Yes, pre-book an SUV or van if you have considerable luggage."},{"question":"Do you offer Uber-like services?","answer":"No, we provide strictly pre-booked, scheduled transfer services."}]} title="Frequently Asked Questions" />
                </div>
            </section>
