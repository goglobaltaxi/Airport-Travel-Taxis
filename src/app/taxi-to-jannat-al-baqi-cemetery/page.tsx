...
export const metadata: Metadata = {
    title: 'Taxi to Jannat Al Baqi Cemetery | Professional Pre-Booked Service',
    description: 'Book a professional taxi to Jannat Al Baqi Cemetery. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across Saudi Arabia and the GCC.',
    openGraph: {
        title: 'Taxi to Jannat Al Baqi Cemetery | Professional Pre-Booked Service',
        description: 'Book a professional taxi to Jannat Al Baqi Cemetery. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across Saudi Arabia and the GCC.',
        url: 'https://airporttraveltaxis.com/taxi-to-jannat-al-baqi-cemetery',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/taxi-to-jannat-al-baqi-cemetery',
    },
};
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Taxi to Jannat al Baqi Cemetery</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h1 className="font-display text-4xl lg:text-5xl text-surface-900 mb-6 leading-tight">
                                Taxi to <span className="text-primary-600">Jannat al Baqi Cemetery</span>
                            </h1>
                            ...
                            <p className="text-surface-600 text-lg leading-relaxed mb-8">
                                Arrive at Jannat al Baqi Cemetery with professional, reliable transport. Our factual, organized approach ensures you reach your destination smoothly.
                            </p>
                        </div>
                    ...
                    <div className="grid gap-8">
                        ...
                        <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8">
                            ...
                            <p className="text-surface-700 text-lg leading-relaxed">
                                Jannat al Baqi is the oldest and first Islamic cemetery in Madinah, located adjacent to the Prophet's Mosque. Many pilgrims visit to pay their respects.
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="border border-surface-200 rounded-2xl p-8">
                                ...
                                <p className="text-surface-600 leading-relaxed">
                                    While it is adjacent to the mosque, arriving from outer Madinah hotels, the airport, or train stations requires reliable pre-booked transport.
                                </p>
                            </div>
                            <div className="border border-surface-200 rounded-2xl p-8">
                                <h3 className="font-display text-2xl text-surface-900 mb-4 flex items-center gap-2">
                                ...
                                <p className="text-surface-600 leading-relaxed">
                                    From Madinah Airport, the journey takes 25 to 35 minutes. From outer Madinah districts, travel takes 10 to 20 minutes.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="bg-primary-900 rounded-[32px] p-8 md:p-12 text-white shadow-xl">
                        ...
                        <div className="grid sm:grid-cols-2 gap-6">
                            {["Checking visitor timings is recommended before booking transport.","Confirm hotel pickup points.","A short transit from distant hotels can be entirely pre-scheduled.","Combine this visit with your journey to Masjid an Nabawi."].map((tip, i) => (
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"How far is this location from Madinah hotels?","answer":"It is centrally located in Madinah, immediately next to Masjid an Nabawi."},{"question":"Can groups travel together?","answer":"Yes, we facilitate group travel with appropriately sized vehicles."},{"question":"Are airport pickups available?","answer":"Yes, direct transport from Madinah Airport to the central area is provided."}]} title="Frequently Asked Questions" />
                </div>
            </section>
