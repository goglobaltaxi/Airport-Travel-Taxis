        ...
        <div className="pt-20">
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    ...
                    <div className="bg-white p-6 md:p-10 rounded-2xl shadow-sm border border-surface-200">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <a href="https://wa.me/966575806733" className="btn-primary flex items-center justify-center gap-2 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-500 hover:to-green-400 border-green-600 text-white shadow-lg w-full sm:w-auto px-8 py-3 rounded-xl font-bold">
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="grid md:grid-cols-2 gap-12">
                        ...
                        <div className="bg-surface-50 p-6 md:p-8 rounded-2xl border border-surface-200">
                            ...
                            <a href="https://wa.me/966575806733" className="text-gold-600 font-bold hover:text-gold-500 inline-flex items-center gap-1 transition-colors mt-2">
                                    ...
                                    {border.pricingTable.map((row, index) => (
                                        <tr key={index} className="hover:bg-surface-50 transition-colors">
                                            ...
                                            <td className="p-4 md:p-5 text-center">
                                                <a 
                                                    href={`https://wa.me/966575806733?text=${encodeURIComponent(`Hi, I want to book a taxi for route: ${row.route}`)}`}
                        ...
                        {vehicles.filter(v => ['s-class', 'gmc', 'vito', 'sprinter'].includes(v.id)).map((vehicle) => (
                            <div key={vehicle.id} className="group overflow-hidden flex flex-col h-full border border-surface-200 hover:border-gold-500/50 hover:shadow-lg transition-all duration-300 bg-white rounded-2xl">
                                ...
                                <div className="p-5 flex flex-col flex-grow">
                                    ...
                                    <a 
                                        href={`https://wa.me/966575806733?text=${encodeURIComponent(`Hi, I want to book the ${vehicle.name} taxi crossing the ${border.name}`)}`}
            ...
            <section className="section-padding bg-primary-900 text-white text-center">
                <div className="container-custom mx-auto max-w-2xl">
                    ...
                    <a href="https://wa.me/966575806733" className="bg-white text-primary-900 font-bold text-lg px-8 py-4 rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all inline-flex items-center gap-3">
