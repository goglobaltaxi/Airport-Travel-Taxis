...
export async function generateStaticParams() {
    return stationPages.map((page) => ({ slug: page.slug }));
}

export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
    const page = stationPages.find((p) => p.slug === params.slug);
    if (!page) return {};
    
    const pageTitle = `Taxi to ${page.stationName} in ${page.city} | Professional Service`;
    const pageDescription = `Book a professional taxi to ${page.stationName} in ${page.city}. We provide safe, pre-booked 24/7 transportation with professional chauffeurs for sightseeing.`;
    ...
    return {
        ...
        openGraph: {
            title: pageTitle,
            description: pageDescription,
            url: `https://airporttraveltaxis.com/taxi-to-station/${page.slug}`,
        },
        alternates: {
            canonical: `https://airporttraveltaxis.com/taxi-to-station/${page.slug}`,
        },
    };
}

export default function StationTaxiPage({ params }: { params: { slug: string } }) {
    const page = stationPages.find((p) => p.slug === params.slug);
    if (!page) notFound();
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6">
                        ...
                        <span>/</span>
                        <span className="text-surface-900">Taxi to {page.stationName}</span>
                    </div>

                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            <div className="inline-flex items-center gap-2 bg-primary-50 border border-primary-200 rounded-full px-4 py-1.5 mb-4">
                                <TrainFront className="w-4 h-4 text-primary-600" />
                                <span className="text-sm text-primary-700 font-medium">
                                    {page.stationType} — {page.city}, {page.cityCountry}
                                </span>
                            </div>
                            <h1 className="font-display text-3xl lg:text-[42px] lg:leading-[48px] text-surface-900 mb-4">
                                Taxi to {page.stationName}{' '}
                            ...
                            <div className="flex flex-wrap gap-2">
                                {['Railway Station', 'Metro Link', 'Public Transport', 'Airport Transfer', 'Hotel Pickup', 'Group Travel'].map((tag) => (
            ...
            <section className="section-padding bg-white">
                <div className="container-custom mx-auto">
                    ...
                    <p className="text-surface-500 mb-8">Information about {page.stationName} as a major transport hub in {page.city}.</p>
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto">
                    ...
                    <p className="text-surface-500 mb-8">
                        We provide reliable transportation to {page.stationName} from any location in the city.
                    </p>
                        ...
                        {[
                            {
                                ...
                                desc: `Direct transfers for passengers arriving by air and connecting to the rail network.`,
                            },
                            {
                                icon: Building2,
                            ...
                            },
                            {
                                ...
                                desc: `Safe and reliable door-to-door service from your residential address to the hub.`,
                            },
                            {
                                icon: Map,
                    ...
                    <div className="bg-primary-50 border border-primary-200 rounded-xl p-6 flex flex-col items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-surface-600 text-sm leading-relaxed">
                                Travel time to {page.stationName} depends on your pickup point in {page.city} and current traffic. We suggest arriving early for train and metro departures.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto">
                    ...
                    <p className="text-surface-500 mb-8">
                        Our fleet serves all passenger needs, whether you are traveling solo or with a large group.
                    </p>
            ...
            <section className="section-padding bg-white">
                <div className="container-custom mx-auto max-w-3xl">
                    ...
                    <p className="text-surface-500 mb-8">Practical guidance for a smooth transition from your taxi to the station platform.</p>
