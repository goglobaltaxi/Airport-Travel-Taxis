...
export const metadata: Metadata = {
    title: 'Taxi from Jeddah Airport to Makkah Hotel | Book Online',
    description: 'Book a professional taxi from Jeddah Airport to Makkah Hotel. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
    openGraph: {
        title: 'Taxi from Jeddah Airport to Makkah Hotel | Book Online',
        description: 'Book a professional taxi from Jeddah Airport to Makkah Hotel. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
        url: 'https://airporttraveltaxis.com/taxi-from-jeddah-airport-to-makkah-hotel',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/taxi-from-jeddah-airport-to-makkah-hotel',
    },
};
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Taxi from Jeddah Airport to Makkah Hotel</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h1 className="font-display text-4xl lg:text-5xl text-surface-900 mb-6 leading-tight">
                                Taxi from Jeddah Airport to <span className="text-primary-600">Makkah Hotel</span>
                            </h1>
                            ...
                            <p className="text-surface-600 text-lg leading-relaxed mb-6">
                                Professional transfer from Jeddah Airport to your Makkah Hotel. Dedicated pre-booked transportation for Umrah travel. Our service ensures a safe, direct, and factual transfer without any hidden surprises.
                            </p>
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-8">
                                <div className="bg-white border border-surface-200 rounded-2xl p-5 shadow-sm">
                                    ...
                                    <p className="text-surface-900 font-semibold">95 km</p>
                                </div>
                                <div className="bg-white border border-surface-200 rounded-2xl p-5 shadow-sm">
                                    ...
                                    <p className="text-surface-900 font-semibold">75-90 minutes</p>
                                </div>
                            </div>
                        </div>
            ...
            <section className="section-padding bg-white border-y border-surface-200">
                <div className="container-custom mx-auto max-w-4xl text-center">
                    ...
                    <p className="text-surface-600 text-lg leading-relaxed">
                        The journey from Jeddah Airport to Makkah Hotel covers approximately 95 km. 
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {["Driver waits at the Jeddah Airport arrivals area.","Luggage assistance provided.","Direct transfer to your specific hotel in Makkah.","Safe and focused driving to the holy city."].map((step, i) => (
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="bg-white border border-surface-200 rounded-[32px] overflow-hidden shadow-sm">
                        ...
                        <div className="p-8 grid sm:grid-cols-2 gap-6">
                            {["Confirm your arrival terminal and hotel name before landing.","Share your flight number so the driver can monitor delays.","Prepare for a one-hour plus journey."].map((tip, i) => (
            ...
            <section className="section-padding bg-white">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"How long does the journey take?","answer":"The trip generally takes 75 to 90 minutes depending on traffic levels."},{"question":"Can airport pickup be arranged for Umrah travelers?","answer":"Yes, we accommodate arriving Umrah pilgrims."},{"question":"Can groups travel together?","answer":"Yes, our large vans and buses can transport big groups together."}]} title="Frequently Asked Questions" />
                </div>
            </section>
