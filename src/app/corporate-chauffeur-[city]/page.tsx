            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto max-w-4xl">
                    ...
                    <div className="bg-white p-6 md:p-10 rounded-2xl shadow-sm border border-surface-200">
                        ...
                        <a href="https://wa.me/966575806733" className="btn-primary inline-flex items-center gap-2 bg-gradient-to-r from-green-600 to-green-500 text-white px-8 py-3 rounded-xl font-bold shadow-lg">
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="grid md:grid-cols-2 gap-12">
                        ...
                        <div className="bg-surface-50 p-6 md:p-8 rounded-2xl border border-surface-200">
                            ...
                            <a href="https://wa.me/966575806733" className="text-gold-600 font-bold hover:text-gold-500 inline-flex items-center gap-1 transition-colors mt-4 block">
