...
export const metadata: Metadata = {
    title: 'Taxi from Madinah Airport to Madinah City | Book Online',
    description: 'Book a professional taxi from Madinah Airport to Madinah City. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
    openGraph: {
        title: 'Taxi from Madinah Airport to Madinah City | Book Online',
        description: 'Book a professional taxi from Madinah Airport to Madinah City. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
        url: 'https://airporttraveltaxis.com/taxi-from-madinah-airport-to-madinah-city',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/taxi-from-madinah-airport-to-madinah-city',
    },
};
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Taxi from Madinah Airport to Madinah City</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h1 className="font-display text-4xl lg:text-5xl text-surface-900 mb-6 leading-tight">
                                Taxi from Madinah Airport to Madinah City
                            </h1>
                            ...
                            <p className="text-surface-600 text-lg leading-relaxed mb-8">
                                Arrive smoothly and travel to Madinah City. Our professional transit focus ensures your pre-booked journey from the airport is fully reliable.
                            </p>
                        </div>
                ...
                <div className="container-custom mx-auto max-w-5xl">
                    <div className="grid md:grid-cols-2 gap-8 mb-8">
                        ...
                        <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8 h-full">
                            ...
                            <p className="text-surface-700 leading-relaxed">
                                Prince Mohammad Bin Abdulaziz Airport (MED) is the primary entry point for pilgrims directly visiting Madinah. An organized, pre-booked transfer ensures a smooth arrival and quick transit to your city accommodation.
                            </p>
                        </div>
                        ...
                        <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8 h-full">
                            ...
                            <p className="text-surface-700 leading-relaxed">
                                Your driver will be stationed at the Madinah Airport arrivals hall. This guarantees immediate departure toward your hotel without standing in taxi lines. Ride-hailing apps are not part of our pre-booked service.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="border border-surface-200 rounded-2xl p-8">
                        ...
                        <p className="text-surface-600 leading-relaxed md:text-lg">
                            The airport is situated about 20 kilometers from the central Madinah hotel district near Masjid an Nabawi. The travel time is approximately 25 to 35 minutes.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="bg-primary-900 rounded-[32px] p-8 md:p-12 text-white shadow-xl">
                        ...
                        <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-6">
                            {["Verify the passenger count precisely when booking to ensure luggage fits.","Keep your driver’s contact information accessible upon landing.","Note your specific hotel entrance, as many are densely located near the mosque."].map((tip, i) => (
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"Is this an exclusive airport transfer service?","answer":"Yes, Airport Travel Taxis provides scheduled, pre-booked transfers."},{"question":"Can I find this service outside the airport on arrival?","answer":"No, all journeys must be reserved in advance of your flight."},{"question":"Will the driver help with luggage?","answer":"Yes, the driver assists with loading your suitcases into the vehicle."}]} title="Frequently Asked Questions" />
                </div>
            </section>
