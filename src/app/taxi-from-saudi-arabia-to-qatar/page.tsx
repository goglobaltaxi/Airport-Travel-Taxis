...
export const metadata: Metadata = {
    title: 'Taxi from Saudi Arabia to Qatar | Book Online',
    description: 'Book a professional taxi from Saudi Arabia to Qatar. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
    openGraph: {
        title: 'Taxi from Saudi Arabia to Qatar | Book Online',
        description: 'Book a professional taxi from Saudi Arabia to Qatar. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
        url: 'https://airporttraveltaxis.com/taxi-from-saudi-arabia-to-qatar',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/taxi-from-saudi-arabia-to-qatar',
    },
};
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Taxi from Saudi Arabia to Qatar (Salwa Border)</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h1 className="font-display text-4xl lg:text-5xl text-surface-900 mb-6 leading-tight">
                                Taxi from Saudi Arabia to Qatar (Salwa Border)
                            </h1>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8">
                                ...
                                <p className="text-surface-700 leading-relaxed">
                                    Traveling from Saudi Arabia to Qatar involves crossing the Salwa Border. We provide pre-booked cross-border transportation for this international route. Short-distance city rides and ride-hailing services are strictly not offered.
                                </p>
                            </div>
                            <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8">
                                ...
                                <p className="text-surface-700 leading-relaxed">
                                    The border crossing at Salwa requires thorough documentation checks. Passengers remain in the vehicle while the driver assists with coordinating the customs and immigration stops on both the Saudi and Qatari sides of the border.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="border border-surface-200 rounded-2xl p-8">
                                ...
                                <p className="text-surface-600 leading-relaxed">
                                    We arrange pickups from major Saudi cities including Riyadh, Dammam, and Al Ahsa, as well as airports and hotels.
                                </p>
                            </div>
                            <div className="border border-surface-200 rounded-2xl p-8">
                                <h3 className="font-display text-2xl text-surface-900 mb-4 flex items-center gap-2">
                                ...
                                <p className="text-surface-600 leading-relaxed">
                                    From Riyadh to the Salwa border is approximately 460 kilometers, taking around 4.5 to 5.5 hours. From Dammam, it is roughly 160 kilometers, taking about 1.5 to 2 hours.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="bg-primary-900 rounded-[32px] p-8 md:p-12 text-white shadow-xl">
                        ...
                        <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-6">
                            {["Ensure your passport, visa, and all travel documents are valid.","Expect delays at the border during holidays and weekends.","Keep your identification easily accessible during the journey."].map((tip, i) => (
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"Do you offer on-demand rides to the border?","answer":"No, all cross-border transportation must be pre-booked in advance."},{"question":"Does the vehicle cross the border?","answer":"Generally, yes, our pre-booked vehicles are cleared to travel across the border to your final destination."},{"question":"Can large families book this trip?","answer":"Yes, we have high-capacity passenger vans and buses for family travel."}]} title="Frequently Asked Questions" />
                </div>
            </section>
