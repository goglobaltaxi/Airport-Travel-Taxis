...
export const metadata: Metadata = {
    title: 'Taxi from Jeddah Airport to Madinah | Book Online',
    description: 'Book a professional taxi from Jeddah Airport to Madinah. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
    openGraph: {
        title: 'Taxi from Jeddah Airport to Madinah | Book Online',
        description: 'Book a professional taxi from Jeddah Airport to Madinah. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
        url: 'https://airporttraveltaxis.com/taxi-from-jeddah-airport-to-madinah',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/taxi-from-jeddah-airport-to-madinah',
    },
};
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Taxi from Jeddah Airport to Madinah</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <p className="text-surface-600 text-lg leading-relaxed mb-8">
                                Arrive smoothly and travel to Madinah. Our professional transit focus ensures your pre-booked journey from the airport is fully reliable.
                            </p>
                        </div>
                ...
                <div className="container-custom mx-auto max-w-5xl">
                    <div className="grid md:grid-cols-2 gap-8 mb-8">
                        ...
                        <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8 h-full">
                            ...
                            <p className="text-surface-700 leading-relaxed">
                                Some pilgrims choose to travel directly from Jeddah Airport to Madinah before visiting Makkah. This is a long-distance intercity transfer requiring reliable pre-booked transportation.
                            </p>
                        </div>
                        ...
                        <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8 h-full">
                            ...
                            <p className="text-surface-700 leading-relaxed">
                                The driver awaits you at the Jeddah Airport arrivals terminal holding a sign. They will assist with luggage loading and begin the direct highway transit to Madinah. We do not offer local ride-hailing style services.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="border border-surface-200 rounded-2xl p-8">
                        ...
                        <p className="text-surface-600 leading-relaxed md:text-lg">
                            The distance from Jeddah Airport to Madinah is roughly 420 kilometers. The continuous driving time is estimated at 4 to 5 hours via the Al Hijrah highway.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="bg-primary-900 rounded-[32px] p-8 md:p-12 text-white shadow-xl">
                        ...
                        <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-6">
                            {["Prepare for a long road journey after your flight by carrying water.","Pre-book a spacious vehicle such as a passenger van if traveling with considerable luggage.","Communicate any need for rest stops with your driver during the long drive."].map((tip, i) => (
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"Does the service provide a direct run to Madinah?","answer":"Yes, this is a dedicated, direct door-to-door transfer after your flight lands."},{"question":"Are there any hidden costs or meters?","answer":"We do not mention prices here, but all details are finalized strictly during the pre-booking process with no meters used."},{"question":"Are there larger vehicles for families?","answer":"Yes, vehicles like the Mercedes Sprinter or GMC are ideal for this route."}]} title="Frequently Asked Questions" />
                </div>
            </section>
