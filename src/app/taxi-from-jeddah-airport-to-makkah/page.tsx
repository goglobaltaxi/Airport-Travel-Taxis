...
export const metadata: Metadata = {
    title: 'Taxi from Jeddah Airport to Makkah | Book Online',
    description: 'Book a professional taxi from Jeddah Airport to Makkah. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
    openGraph: {
        title: 'Taxi from Jeddah Airport to Makkah | Book Online',
        description: 'Book a professional taxi from Jeddah Airport to Makkah. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
        url: 'https://airporttraveltaxis.com/taxi-from-jeddah-airport-to-makkah',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/taxi-from-jeddah-airport-to-makkah',
    },
};
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Taxi from Jeddah Airport to Makkah</span>
                    </div>
                ...
                <div className="container-custom mx-auto max-w-5xl">
                    <div className="grid md:grid-cols-2 gap-8 mb-8">
                        ...
                        <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8 h-full">
                            ...
                            <p className="text-surface-700 leading-relaxed">
                                Traveling from King Abdulaziz International Airport (JED) in Jeddah to Makkah is the most common route for pilgrims performing Umrah and Hajj. We provide structured, pre-booked airport transfers for this important journey.
                            </p>
                        </div>
                        ...
                        <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8 h-full">
                            ...
                            <p className="text-surface-700 leading-relaxed">
                                Your assigned driver will monitor your flight and meet you in the designated arrivals area at Jeddah Airport. Assistance with luggage is provided, and the driver will guide you directly to your pre-booked vehicle. Street taxi hailing and short-distance local rides are not offered.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="border border-surface-200 rounded-2xl p-8">
                        ...
                        <p className="text-surface-600 leading-relaxed md:text-lg">
                            The distance is approximately 95 kilometers. The journey typically takes 75 to 90 minutes, depending heavily on highway traffic and entry points into Makkah.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="bg-primary-900 rounded-[32px] p-8 md:p-12 text-white shadow-xl">
                        ...
                        <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-6">
                            {["Provide your complete flight arriving details when confirming your book.","Ensure the drop-off hotel name and location in Makkah are accurate.","Expect longer travel times and potential delays during Ramadan and Hajj seasons."].map((tip, i) => (
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"Is this an ad-hoc or on-demand service?","answer":"No, Airport Travel Taxis provides strictly pre-booked airport transfers."},{"question":"Will the driver wait if my flight is delayed?","answer":"Yes, we track your flight status to adjust the pickup time accordingly."},{"question":"Can large family groups travel together?","answer":"Yes, we have high-capacity passenger vans and buses available for groups."}]} title="Frequently Asked Questions" />
                </div>
            </section>
