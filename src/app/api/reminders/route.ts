...
<div class="wrap">
  ...
  <div class="body">
    ...
    <a href="https://wa.me/966575806733?text=${encodeURIComponent(`Hi, I have a booking tomorrow. Reference: ${ref}`)}" class="cta">💬 Contact Us on WhatsApp</a>
  </div>
  <div class="footer">Airport Travel Taxis · booking@airporttraveltaxis.com · +966 57 580 6733</div>
</div>
</body></html>`;
