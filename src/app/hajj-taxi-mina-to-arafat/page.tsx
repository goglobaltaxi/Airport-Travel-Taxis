...
export const metadata: Metadata = {
    title: 'Hajj Taxi: Mina To Arafat | Pre-Booked Transfer Service',
    description: 'Book a professional Hajj taxi for the Mina To Arafat route. We provide safe, pre-booked 24/7 transportation with professional chauffeurs for pilgrims during Hajj.',
    openGraph: {
        title: 'Hajj Taxi: Mina To Arafat | Pre-Booked Transfer Service',
        description: 'Book a professional Hajj taxi for the Mina To Arafat route. We provide safe, pre-booked 24/7 transportation with professional chauffeurs for pilgrims during Hajj.',
        url: 'https://airporttraveltaxis.com/hajj-taxi-mina-to-arafat',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/hajj-taxi-mina-to-arafat',
    },
};
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Hajj Taxi from Mina to Arafat</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h1 className="font-display text-4xl lg:text-5xl text-surface-900 mb-6 leading-tight">
                                Hajj Taxi from Mina to <span className="text-primary-600">Arafat</span>
                            </h1>
                            ...
                            <p className="text-surface-600 text-lg leading-relaxed mb-6">
                                Pre-booked transfer from Mina to Arafat during the Hajj pilgrimage.
                            </p>
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-8">
                                <div className="bg-white border border-surface-200 rounded-2xl p-5 shadow-sm">
                                    ...
                                    <p className="text-surface-900 font-semibold">14 km</p>
                                </div>
                                <div className="bg-white border border-surface-200 rounded-2xl p-5 shadow-sm">
                                    ...
                                    <p className="text-surface-900 font-semibold">45-120 minutes</p>
                                </div>
                            </div>
                        </div>
            ...
            <section className="section-padding bg-white border-y border-surface-200">
                <div className="container-custom mx-auto max-w-4xl text-center">
                    ...
                    <p className="text-surface-600 text-lg leading-relaxed">
                        Moving from Mina to Arafat is a significant step in the Hajj process. Our pre-booked vehicles provide a planned and organized method for this specific journey. By reserving early, pilgrims secure reliable transit without relying on ad-hoc local services.
                    </p>
                </div>
            </section>
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {["Pickup from the authorized location near your Mina camp.","Organized boarding for all group members.","Transit via designated routes towards Arafat.","Drop-off near your designated Arafat zone."].map((step, i) => (
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="bg-white border border-surface-200 rounded-[32px] overflow-hidden shadow-sm">
                        ...
                        <div className="p-8 grid sm:grid-cols-2 gap-6">
                            {["Confirm pickup points as roads can change.","Allow extra travel time due to traffic.","Expect delays and remain patient during the transit.","Maintain communication with your group leader."].map((tip, i) => (
            ...
            <section className="section-padding bg-white">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"How do pilgrims travel between Hajj locations?","answer":"Our drivers follow the specific traffic patterns designated for pilgrims."},{"question":"Can groups travel together?","answer":"Yes, high-capacity coaches and vans allow families to stay together."},{"question":"Are roads open to all vehicles?","answer":"Only authorized and properly permitted vehicles navigate these routes."}]} title="Frequently Asked Questions" />
                </div>
            </section>
