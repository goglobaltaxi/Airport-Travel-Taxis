...
export async function generateStaticParams() {
    return portPages.map((page) => ({ slug: page.slug }));
}

export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
    const page = portPages.find((p) => p.slug === params.slug);
    if (!page) return {};
    
    const pageTitle = `Taxi to ${page.portName} in ${page.city} | Professional Service`;
    const pageDescription = `Book a professional taxi to ${page.portName} in ${page.city}. We provide safe, pre-booked 24/7 transportation with professional chauffeurs for sightseeing.`;
    ...
    return {
        ...
        openGraph: {
            title: pageTitle,
            description: pageDescription,
            url: `https://airporttraveltaxis.com/taxi-to-port/${page.slug}`,
        },
        alternates: {
            canonical: `https://airporttraveltaxis.com/taxi-to-port/${page.slug}`,
        },
    };
}

export default function PortTaxiPage({ params }: { params: { slug: string } }) {
    const page = portPages.find((p) => p.slug === params.slug);
    if (!page) notFound();
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6">
                        ...
                        <span>/</span>
                        <span className="text-surface-900">Taxi to {page.portName}</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {['Cruise Terminal', 'Seaport', 'Maritime Hub', 'Airport Transfer', 'Hotel Pickup', 'Group Travel'].map((tag) => (
            ...
            <section className="section-padding bg-white">
                <div className="container-custom mx-auto">
                    ...
                    <p className="text-surface-500 mb-8">Details about {page.portName} as a major maritime hub in {page.city}.</p>
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {page.features.map((feature, i) => (
                            <div key={i} className="flex items-start gap-3 bg-surface-50 border border-surface-200 rounded-xl p-4">
                                <Ship className="w-5 h-5 text-primary-600 mt-0.5 flex-shrink-0" />
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto">
                    ...
                    <p className="text-surface-500 mb-8">
                        Our drivers can collect you from any location for your journey to {page.portName}.
                    </p>
                        ...
                        {[
                            {
                                ...
                                desc: `Punctual transfers for travelers arriving by air to meet their maritime departure.`,
                            },
                            {
                                icon: Building2,
                                title: 'Hotel Collection',
                                desc: `Pickups from any hotel or tourist residence in the city area.`,
                            },
                            {
                                icon: Home,
                                title: 'Home or Residence',
                                desc: `Door-to-door service from your residential address directly to the port terminal.`,
                            },
                            {
                                icon: Map,
                                title: 'City Centers',
                                desc: `Pickup from downtown areas, business districts, or major city landmarks.`,
                            },
                    ...
                    <div className="bg-primary-50 border border-primary-200 rounded-xl p-6 flex flex-col items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-surface-600 text-sm leading-relaxed">
                                Travel time to {page.portName} varies based on your pickup location in {page.city} and current traffic. We recommend starting your journey early to account for port security and check-in procedures.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto">
                    ...
                    <p className="text-surface-500 mb-8">
                        Select a vehicle that matches your group size and luggage requirements for port travel.
                    </p>
            ...
            {/* Travel Tips for Maritime Passengers */}
            <section className="section-padding bg-white">
                <div className="container-custom mx-auto max-w-3xl">
                    <h2 className="font-display text-2xl lg:text-3xl text-surface-900 mb-2">
                        Travel Tips for Passengers
                    </h2>
                    <p className="text-surface-500 mb-8">Practical guidance for a smooth journey to {page.portName}.</p>
