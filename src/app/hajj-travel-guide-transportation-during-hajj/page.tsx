...
export const metadata: Metadata = {
    title: 'Hajj Travel Guide: Transportation During Hajj | Airport Travel Taxis',
    description: 'Essential Hajj travel guide for Transportation During Hajj. Discover reliable pre-booked transportation options and logistics for your pilgrimage to the holy cities.',
    openGraph: {
        title: 'Hajj Travel Guide: Transportation During Hajj | Airport Travel Taxis',
        description: 'Essential Hajj travel guide for Transportation During Hajj. Discover reliable pre-booked transportation options and logistics for your pilgrimage to the holy cities.',
        url: 'https://airporttraveltaxis.com/hajj-travel-guide-transportation-during-hajj',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/hajj-travel-guide-transportation-during-hajj',
    },
};
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Hajj Travel Guide: Transportation during Hajj pilgrimage</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h1 className="font-display text-4xl lg:text-5xl text-surface-900 mb-6 leading-tight">
                                Transportation during Hajj pilgrimage
                            </h1>
                        ...
                        <div className="space-y-10">
                            <div>
                                ...
                                <p className="text-surface-600 text-lg leading-relaxed">
                                    Hajj involves movement across specific zones within strict timeframes. Reliable, organized transportation is essential for a safe and focused pilgrimage.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-surface-600 text-lg leading-relaxed">
                                    Airport Travel Taxis supplies pre-booked vehicles for airport and intercity transfers during the season. Local street rides and short city hops are not provided.
                                </p>
                            </div>
                            ...
                            <div className="bg-surface-50 border border-surface-200 rounded-2xl p-6">
                                ...
                                <p className="text-surface-700 font-medium leading-relaxed">
                                    Travel times and distances vary by route. For example, Jeddah Airport to Makkah is 95km, but travel times are heavily extended during Hajj.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-10">
                            <div className="bg-primary-900 text-white rounded-[32px] overflow-hidden shadow-sm">
                                <div className="p-8">
                                    ...
                                    <div className="space-y-4">
                                        {["Finalize your transportation schedule months in advance.","Maintain flexibility regarding specific travel times due to traffic.","Carry required identification and permits at all times.","Always rely on your reserved transportation."].map((tip, i) => (
                            ...
                            <div>
                                ...
                                <ul className="space-y-3">
                                    {["Jeddah Airport to Makkah","Makkah to Madinah","Makkah to Mina"].map((route, i) => (
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"Do you provide on-demand taxis?","answer":"No, all our transportation services are strictly pre-booked."},{"question":"Are vehicles available for airport transfers?","answer":"Yes, advance airport transfers are fully supported."},{"question":"How early should I book?","answer":"As early as possible, prior to the Hajj season commencing."}]} title="Frequently Asked Questions" />
                </div>
            </section>
