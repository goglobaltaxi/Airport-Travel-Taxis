...
export async function generateStaticParams() {
    return terminalPages.map((page) => ({ slug: page.slug }));
}

export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
    const page = terminalPages.find((p) => p.slug === params.slug);
    if (!page) return {};
    
    const pageTitle = `Taxi to ${page.airportName} T${page.terminalNumber} | Professional Service`;
    const pageDescription = `Book a professional taxi to ${page.airportName} Terminal ${page.terminalNumber} in ${page.city}. We provide safe, pre-booked 24/7 transportation with professional chauffeurs for sightseeing.`;
    ...
    return {
        ...
        openGraph: {
            title: pageTitle,
            description: pageDescription,
            url: `https://airporttraveltaxis.com/taxi-to-terminal/${page.slug}`,
        },
        alternates: {
            canonical: `https://airporttraveltaxis.com/taxi-to-terminal/${page.slug}`,
        },
    };
}

export default function TerminalTaxiPage({ params }: { params: { slug: string } }) {
    const page = terminalPages.find((p) => p.slug === params.slug);
    if (!page) notFound();

    const vehicles = [
        { name: 'Mercedes S-Class', type: 'Executive Sedan', desc: 'Premium comfort for travel to major airport terminals.' },
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6">
                        ...
                        <span>/</span>
                        <span className="text-surface-900">Taxi to {page.airportName} Terminal {page.terminalNumber}</span>
                    </div>
                        ...
                        <div>
                            <div className="inline-flex items-center gap-2 bg-primary-50 border border-primary-200 rounded-full px-4 py-1.5 mb-4">
                                ...
                                <span className="text-sm text-primary-700 font-medium">
                                    {page.terminalType} — Terminal {page.terminalNumber}
                                </span>
                            </div>
                            <h1 className="font-display text-3xl lg:text-[42px] lg:leading-[48px] text-surface-900 mb-4">
                                Taxi to {page.airportName} <span className="text-primary-600">Terminal {page.terminalNumber}</span>
                            </h1>
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-6">
                                <div className="bg-white border border-surface-200 rounded-xl p-4">
                                    ...
                                    <p className="text-xs text-surface-500 uppercase tracking-wide font-medium mb-1">City</p>
                                    <p className="text-surface-900 font-semibold text-sm">{page.city}, {page.cityCountry}</p>
                                </div>
                                <div className="bg-white border border-surface-200 rounded-xl p-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {['Departures', 'Arrivals', 'International terminal', 'Airport Pickup', 'Hotel Transfer', 'Group Travel'].map((tag) => (
            ...
            <section className="section-padding bg-white">
                <div className="container-custom mx-auto">
                    ...
                    <p className="text-surface-500 mb-8">Information about {page.airportName} Terminal {page.terminalNumber} in {page.city}.</p>
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto">
                    ...
                    <p className="text-surface-500 mb-8">
                        We provide reliable transportation to Terminal {page.terminalNumber} from any location in the city and beyond.
                    </p>
                        ...
                        {[
                            {
                                ...
                                desc: `Safe and reliable door-to-door service from your residential address to the terminal.`,
                            },
                            {
                                icon: Building2,
                                title: 'Hotel Collection',
                                desc: `Pickups from all major hotels, resorts, and tourism districts in the city center.`,
                            },
                            {
                                icon: Map,
                                title: 'City Center',
                                desc: `Convenient pickup from central business districts and major city landmarks.`,
                            },
                            {
                                icon: MapPin,
                                title: 'Nearby Cities',
                                desc: `Cross-city and regional transfers from neighboring areas directly to the terminal.`,
                            },
                    ...
                    <div className="bg-primary-50 border border-primary-200 rounded-xl p-6 flex flex-col items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-surface-600 text-sm leading-relaxed">
                                Travel time to {page.airportName} Terminal {page.terminalNumber} depends on your pickup point in {page.city} and current traffic conditions. We suggest allowing extra time during peak travel hours.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto">
                    ...
                    <p className="text-surface-500 mb-8">
                        Our fleet serves all passenger needs, whether you are traveling solo for business or with a large family group.
                    </p>
            ...
            <section className="section-padding bg-white">
                <div className="container-custom mx-auto max-w-3xl">
                    ...
                    <p className="text-surface-500 mb-8">Practical guidance for a smooth journey to your airport terminal.</p>
