                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="grid md:grid-cols-2 gap-12">
                        ...
                        <div className="bg-surface-50 p-6 md:p-8 rounded-2xl border border-surface-200">
                            ...
                            <a href="https://wa.me/966575806733" className="text-gold-600 font-bold hover:text-gold-500 inline-flex items-center gap-1 transition-colors">
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            {airport.popularRoutes.map((route) => (
                                <div key={route.to} className="bg-white border border-surface-200 rounded-2xl p-5 shadow-sm">
                                    ...
                                    <a href="https://wa.me/966575806733" className="text-gold-600 text-sm font-bold hover:text-gold-500 transition-colors inline-flex items-center gap-1">
