...
export const metadata: Metadata = {
    title: 'Taxi from Doha Airport to Saudi Border | Book Online',
    description: 'Book a professional taxi from Doha Airport to Saudi Border. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
    openGraph: {
        title: 'Taxi from Doha Airport to Saudi Border | Book Online',
        description: 'Book a professional taxi from Doha Airport to Saudi Border. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
        url: 'https://airporttraveltaxis.com/taxi-from-doha-airport-to-saudi-border',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/taxi-from-doha-airport-to-saudi-border',
    },
};
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Taxi from Doha Airport to Saudi Border</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h1 className="font-display text-4xl lg:text-5xl text-surface-900 mb-6 leading-tight">
                                Taxi from Doha Airport to Saudi Border
                            </h1>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8">
                                ...
                                <p className="text-surface-700 leading-relaxed">
                                    Passengers arriving at Hamad International Airport (DOH) in Qatar and proceeding to Saudi Arabia by road cross at the Salwa/Abu Samra border. We arrange structural, pre-booked airport transfers for this route.
                                </p>
                            </div>
                            <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8">
                                <h2 className="font-display text-2xl text-surface-900 mb-4 flex items-center gap-2">
                                ...
                                <p className="text-surface-700 leading-relaxed">
                                    Your assigned driver will be stationed in the arrivals area of the Doha airport. The transition from your flight to the vehicle is organized smoothly. We do not provide ride-hailing style services on demand.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="border border-surface-200 rounded-2xl p-8">
                                ...
                                <p className="text-surface-600 leading-relaxed">
                                    You will depart Qatar through the Abu Samra exit point and enter Saudi Arabia at Salwa. The driver coordinates the vehicle clearance through customs.
                                </p>
                            </div>
                            <div className="border border-surface-200 rounded-2xl p-8">
                                <h3 className="font-display text-2xl text-surface-900 mb-4 flex items-center gap-2">
                                ...
                                <p className="text-surface-600 leading-relaxed">
                                    Doha Airport to the border is approximately 100 kilometers. The drive takes around 1 to 1.5 hours. Total journey time into Saudi Arabia depends on your final destination.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="bg-primary-900 rounded-[32px] p-8 md:p-12 text-white shadow-xl">
                        ...
                        <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-6">
                            {["Pre-book early to ensure a vehicle is reserved for your flight arrival time.","Check your Saudi visa requirements for land border entry.","Communicate any oversize luggage to ensure proper vehicle allocation."].map((tip, i) => (
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"Can you take me to Dammam after the border?","answer":"Yes, the pre-booked service generally extends directly to your final destination in Saudi Arabia."},{"question":"Is this a shared taxi?","answer":"No, our pre-booked transfers are private vehicles for you and your party."},{"question":"Are child seats available?","answer":"Child seat requirements must be indicated during your advance booking."}]} title="Frequently Asked Questions" />
                </div>
            </section>
