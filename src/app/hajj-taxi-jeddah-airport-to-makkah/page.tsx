...
export const metadata: Metadata = {
    title: 'Hajj Taxi: Jeddah Airport To Makkah | Pre-Booked Transfer Service',
    description: 'Book a professional Hajj taxi for the Jeddah Airport To Makkah route. We provide safe, pre-booked 24/7 transportation with professional chauffeurs for pilgrims during Hajj.',
    openGraph: {
        title: 'Hajj Taxi: Jeddah Airport To Makkah | Pre-Booked Transfer Service',
        description: 'Book a professional Hajj taxi for the Jeddah Airport To Makkah route. We provide safe, pre-booked 24/7 transportation with professional chauffeurs for pilgrims during Hajj.',
        url: 'https://airporttraveltaxis.com/hajj-taxi-jeddah-airport-to-makkah',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/hajj-taxi-jeddah-airport-to-makkah',
    },
};
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Hajj Taxi from Jeddah Airport to Makkah</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h1 className="font-display text-4xl lg:text-5xl text-surface-900 mb-6 leading-tight">
                                Hajj Taxi from Jeddah Airport to <span className="text-primary-600">Makkah</span>
                            </h1>
                            ...
                            <p className="text-surface-600 text-lg leading-relaxed mb-6">
                                Pre-booked transfer from Jeddah Airport to Makkah during the Hajj season.
                            </p>
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-8">
                                ...
                                <div className="bg-white border border-surface-200 rounded-2xl p-5 shadow-sm">
                                    ...
                                    <p className="text-surface-900 font-semibold">75-120 minutes</p>
                                </div>
                            </div>
                        </div>
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {["Driver waits at the Jeddah Airport arrivals area with a clear sign.","Assistance provided for loading luggage into the vehicle.","Direct transportation to your accommodation in Makkah.","Drop-off completed at your requested hotel or location."].map((step, i) => (
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="bg-white border border-surface-200 rounded-[32px] overflow-hidden shadow-sm">
                        ...
                        <div className="p-8 grid sm:grid-cols-2 gap-6">
                            {["Book your transportation well in advance of your travel dates.","Confirm your exact arrival terminal and flight details.","Allow extra travel time due to traffic.","Have your hotel address readily available for the driver."].map((tip, i) => (
            ...
            <section className="section-padding bg-white">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"How do pilgrims travel between Hajj locations?","answer":"Pilgrims use pre-booked transportation to move safely and efficiently between locations."},{"question":"Can groups travel together?","answer":"Yes, we provide spacious vans and buses for large groups."},{"question":"Are airport pickups available during Hajj?","answer":"Yes, our airport pickup service operates fully during the pilgrimage season."}]} title="Frequently Asked Questions" />
                </div>
            </section>
