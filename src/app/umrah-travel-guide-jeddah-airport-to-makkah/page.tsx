...
export const metadata: Metadata = {
    title: 'Umrah Travel Guide: Jeddah Airport To Makkah | Airport Travel Taxis',
    description: 'Comprehensive Umrah travel guide focusing on Jeddah Airport To Makkah. Learn about pre-booked transportation, routes, and travel tips for a smooth pilgrimage experience.',
    openGraph: {
        title: 'Umrah Travel Guide: Jeddah Airport To Makkah | Airport Travel Taxis',
        description: 'Comprehensive Umrah travel guide focusing on Jeddah Airport To Makkah. Learn about pre-booked transportation, routes, and travel tips for a smooth pilgrimage experience.',
        url: 'https://airporttraveltaxis.com/umrah-travel-guide-jeddah-airport-to-makkah',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/umrah-travel-guide-jeddah-airport-to-makkah',
    },
};
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Umrah Travel Guide: Travel from Jeddah Airport to Makkah</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h1 className="font-display text-4xl lg:text-5xl text-surface-900 mb-6 leading-tight">
                                Travel from Jeddah Airport to Makkah
                            </h1>
                        ...
                        <div className="space-y-10">
                            <div>
                                ...
                                <p className="text-surface-600 text-lg leading-relaxed">
                                    The journey from Jeddah Airport to Makkah is the starting point for many Umrah pilgrims. Pre-booking your transportation ensures a direct and organized transfer to the holy city without the need to search for transport upon arrival.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-surface-600 text-lg leading-relaxed">
                                    Pilgrims can choose from sedans, SUVs, or larger passenger vans for family groups. Airport Travel Taxis provides strictly pre-booked transportation services; local street taxi rides are not part of our service.
                                </p>
                            </div>
                            ...
                            <div className="bg-surface-50 border border-surface-200 rounded-2xl p-6">
                                ...
                                <p className="text-surface-700 font-medium leading-relaxed">
                                    The distance is approximately 95 kilometers. Travel time is usually 75 to 90 minutes depending on traffic conditions on the highway.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-10">
                            <div className="bg-primary-900 text-white rounded-[32px] overflow-hidden shadow-sm">
                                <div className="p-8">
                                    ...
                                    <div className="space-y-4">
                                        {["Confirm your arrival terminal before landing.","Share your flight details to allow tracking of your arrival.","Keep your hotel address accessible.","Pre-book your vehicle prior to traveling."].map((tip, i) => (
                            ...
                            <div>
                                ...
                                <ul className="space-y-3">
                                    {["Makkah to Madinah","Jeddah Airport to Madinah","Madinah City Transfers"].map((route, i) => (
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"Is street hailing available at the airport?","answer":"No, Airport Travel Taxis provides strictly pre-booked services."},{"question":"What vehicle sizes are available?","answer":"We offer sedans, SUVs, minivans, and buses for larger groups."},{"question":"Can the driver take us directly to our hotel?","answer":"Yes, our service includes direct drop-off at your Makkah accommodation."}]} title="Frequently Asked Questions" />
                </div>
            </section>
