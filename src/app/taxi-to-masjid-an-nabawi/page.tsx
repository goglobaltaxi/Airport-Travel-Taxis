...
export const metadata: Metadata = {
    title: 'Taxi to Masjid An Nabawi | Professional Pre-Booked Service',
    description: 'Book a professional taxi to Masjid An Nabawi. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across Saudi Arabia and the GCC.',
    openGraph: {
        title: 'Taxi to Masjid An Nabawi | Professional Pre-Booked Service',
        description: 'Book a professional taxi to Masjid An Nabawi. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across Saudi Arabia and the GCC.',
        url: 'https://airporttraveltaxis.com/taxi-to-masjid-an-nabawi',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/taxi-to-masjid-an-nabawi',
    },
};
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Taxi to Masjid an Nabawi</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h1 className="font-display text-4xl lg:text-5xl text-surface-900 mb-6 leading-tight">
                                Taxi to <span className="text-primary-600">Masjid an Nabawi</span>
                            </h1>
                            ...
                            <p className="text-surface-600 text-lg leading-relaxed mb-8">
                                Arrive at Masjid an Nabawi with professional, reliable transport. Focus on your spiritual journey while we handle the logistics of your pre-booked travel.
                            </p>
                        </div>
                    ...
                    <div className="grid gap-8">
                        ...
                        <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8">
                            ...
                            <p className="text-surface-700 text-lg leading-relaxed mb-6">
                                Masjid an Nabawi is the Prophet's Mosque in Madinah, the second holiest site in Islam. Pilgrims travel here to pay their respects and perform prayers during their journey.
                            </p>
                            
                            <h3 className="font-bold text-xl text-surface-900 mb-3">Transportation for Pilgrims</h3>
                            <p className="text-surface-600 leading-relaxed">
                                We facilitate longer pre-booked journeys to Madinah, including airport transfers and intercity travel from Makkah. We do NOT provide local street taxi services or short-distance city rides.
                            </p>
                        </div>
                        ...
                        <div className="border border-surface-200 rounded-2xl p-8">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <p className="text-surface-600 leading-relaxed">Long-distance intercity transfers from Jeddah Airport to Madinah.</p>
                                </div>
                                <hr className="border-surface-200" />
                                <div>
                                    <h4 className="font-bold text-surface-900 mb-2">Travel from Makkah Hotels</h4>
                                    <p className="text-surface-600 leading-relaxed">Organized pre-booked travel from Makkah hotels to Madinah accommodations.</p>
                                </div>
                                <hr className="border-surface-200" />
                                <div>
                                    <h4 className="font-bold text-surface-900 mb-2">Travel from Madinah Airport</h4>
                                    <p className="text-surface-600 leading-relaxed">Direct airport transfers from Prince Mohammad Bin Abdulaziz Airport to hotels near Masjid an Nabawi.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8">
                            ...
                            <p className="text-surface-600 leading-relaxed">
                                Madinah Airport to central Madinah takes 25 to 35 minutes. Makkah to Madinah takes 4.5 to 5.5 hours. Jeddah to Madinah takes 4 to 5 hours.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="bg-primary-900 rounded-[32px] p-8 md:p-12 text-white shadow-xl">
                        ...
                        <div className="grid sm:grid-cols-2 gap-6">
                            {["Provide accurate flight details when booking your airport transfer.","Expect longer travel times during the Hajj season or Ramadan.","Ensure all luggage is loaded properly for intercity journeys."].map((tip, i) => (
            ...
            <section className="section-padding bg-white">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"Is street hailing available near the mosque?","answer":"No, all our transportation services must be pre-booked in advance."},{"question":"Do you offer transfers from Makkah to Madinah?","answer":"Yes, we provide pre-booked intercity travel between the holy cities."},{"question":"Can I book a van for my family?","answer":"Yes, passenger vans and buses are available."}]} title="Frequently Asked Questions" />
                </div>
            </section>
