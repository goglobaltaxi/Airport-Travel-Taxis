...
export const metadata: Metadata = {
    title: 'Taxi from Dubai Airport to Saudi Border | Book Online',
    description: 'Book a professional taxi from Dubai Airport to Saudi Border. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
    openGraph: {
        title: 'Taxi from Dubai Airport to Saudi Border | Book Online',
        description: 'Book a professional taxi from Dubai Airport to Saudi Border. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
        url: 'https://airporttraveltaxis.com/taxi-from-dubai-airport-to-saudi-border',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/taxi-from-dubai-airport-to-saudi-border',
    },
};
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Taxi from Dubai Airport to Saudi Border</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h1 className="font-display text-4xl lg:text-5xl text-surface-900 mb-6 leading-tight">
                                Taxi from Dubai Airport to Saudi Border
                            </h1>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8">
                                ...
                                <p className="text-surface-700 leading-relaxed">
                                    Traveling from Dubai International Airport (DXB) directly to the Saudi Arabian border at Al Batha is a long-distance road journey. We facilitate this transit with pre-booked cross-border transfers for arriving passengers.
                                </p>
                            </div>
                            <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8">
                                <h2 className="font-display text-2xl text-surface-900 mb-4 flex items-center gap-2">
                                ...
                                <p className="text-surface-700 leading-relaxed">
                                    Your driver will track your flight and wait in the arrivals hall of Dubai Airport. They will assist with your luggage and guide you to your pre-booked vehicle. We do not offer ad-hoc rides or ride-hailing services.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="border border-surface-200 rounded-2xl p-8">
                                ...
                                <p className="text-surface-600 leading-relaxed">
                                    The Al Batha border crossing involves exiting the UAE and entering Saudi Arabia. Ensure you have the appropriate Saudi entry or transit visa ready for inspection.
                                </p>
                            </div>
                            <div className="border border-surface-200 rounded-2xl p-8">
                                <h3 className="font-display text-2xl text-surface-900 mb-4 flex items-center gap-2">
                                ...
                                <p className="text-surface-600 leading-relaxed">
                                    The distance from Dubai Airport to the Al Batha border is approximately 400 to 450 kilometers. The continuous driving time is roughly 4 to 5 hours depending on traffic conditions on the UAE highways.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="bg-primary-900 rounded-[32px] p-8 md:p-12 text-white shadow-xl">
                        ...
                        <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-6">
                            {["Secure the correct Saudi visa before booking your flight to Dubai.","Confirm the passenger and luggage count when making your reservation.","Prepare for a long journey by carrying water and resting during the drive."].map((tip, i) => (
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"Do you offer local rides within Dubai?","answer":"No, our services are strictly for pre-booked cross-border transfers and long intercity journeys."},{"question":"Does the driver meet me inside the terminal?","answer":"Yes, the driver will hold a sign in the designated arrivals area."},{"question":"Can large families book this transfer?","answer":"Yes, we provide high-capacity passenger vans and buses."}]} title="Frequently Asked Questions" />
                </div>
            </section>
