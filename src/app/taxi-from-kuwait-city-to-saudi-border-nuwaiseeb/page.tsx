...
export const metadata: Metadata = {
    title: 'Taxi from Kuwait City to Saudi Border Nuwaiseeb | Book Online',
    description: 'Book a professional taxi from Kuwait City to Saudi Border Nuwaiseeb. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
    openGraph: {
        title: 'Taxi from Kuwait City to Saudi Border Nuwaiseeb | Book Online',
        description: 'Book a professional taxi from Kuwait City to Saudi Border Nuwaiseeb. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
        url: 'https://airporttraveltaxis.com/taxi-from-kuwait-city-to-saudi-border-nuwaiseeb',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/taxi-from-kuwait-city-to-saudi-border-nuwaiseeb',
    },
};
        ...
        <div className="pt-20">
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Taxi from Kuwait City to Saudi Border (Nuwaiseeb)</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h1 className="font-display text-4xl lg:text-5xl text-surface-900 mb-6 leading-tight">
                                Taxi from Kuwait City to Saudi Border (Nuwaiseeb)
                            </h1>
                ...
                <div className="container-custom mx-auto max-w-5xl">
                    <div className="grid md:grid-cols-2 gap-8 mb-8">
                        <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8">
                            ...
                            <p className="text-surface-700 leading-relaxed">Some travelers require transportation only as far as the Nuwaiseeb border crossing to arrange their own onward travel into Saudi Arabia. We provide a pre-booked one-way transfer to the border.</p>
                        </div>
                        <div className="bg-surface-50 border border-surface-200 rounded-2xl p-8">
                            <h2 className="font-display text-2xl text-surface-900 mb-4 flex items-center gap-2">
                            ...
                            <p className="text-surface-700 leading-relaxed">The Nuwaiseeb crossing is the primary land border between Kuwait and Saudi Arabia. Passengers are dropped off at the Kuwait exit side of the checkpoint.</p>
                        </div>
                    </div>
                    <div className="border border-surface-200 rounded-2xl p-8">
                        ...
                        <p className="text-surface-600 leading-relaxed">Pickups are available from Kuwait City, Kuwait International Airport, and surrounding areas.</p>
                    </div>
                </div>
            </section>
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="bg-primary-900 rounded-[32px] p-8 md:p-12 text-white shadow-xl">
                        ...
                        <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-6">
                            {["Ensure you have your own onward transport arranged inside Saudi Arabia.","Border traffic can vary significantly; book with buffer time.","Carry all travel documents for your Saudi crossing in hand."].map((tip, i) => (
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"Will the driver take me across the border?","answer":"For this route, drop-off is at the Kuwait exit checkpoint."},{"question":"Is this an on-demand service?","answer":"No, all transfers must be pre-booked before travel."},{"question":"Can I upgrade to a full transfer to Dammam?","answer":"Yes, a full cross-border transfer to Dammam or other Saudi cities can be booked instead."}]} title="Frequently Asked Questions" />
                </div>
            </section>
