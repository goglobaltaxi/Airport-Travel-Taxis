...
export const metadata: Metadata = {
    title: 'Taxi from Makkah to Madinah | Book Online',
    description: 'Book a professional taxi from Makkah to Madinah. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
    openGraph: {
        title: 'Taxi from Makkah to Madinah | Book Online',
        description: 'Book a professional taxi from Makkah to Madinah. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
        url: 'https://airporttraveltaxis.com/taxi-from-makkah-to-madinah',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/taxi-from-makkah-to-madinah',
    },
};
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Taxi from Makkah to Madinah</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h1 className="font-display text-4xl lg:text-5xl text-surface-900 mb-6 leading-tight">
                                Taxi from Makkah to <span className="text-primary-600">Madinah</span>
                            </h1>
                            ...
                            <p className="text-surface-600 text-lg leading-relaxed mb-6">
                                Professional transfer from Makkah to Madinah. Advance booking required for this intercity travel service. Our service ensures a safe, direct, and factual transfer without any hidden surprises.
                            </p>
            ...
            <section className="section-padding bg-white border-y border-surface-200">
                <div className="container-custom mx-auto max-w-4xl text-center">
                    ...
                    <p className="text-surface-600 text-lg leading-relaxed">
                        The journey from Makkah to Madinah covers approximately 450 km. 
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {["Pickup from your hotel in Makkah.","Driver assists with luggage.","Direct highway transfer to Madinah.","Drop-off at your Madinah hotel."].map((step, i) => (
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="bg-white border border-surface-200 rounded-[32px] overflow-hidden shadow-sm">
                        ...
                        <div className="p-8 grid sm:grid-cols-2 gap-6">
                            {["Schedule your pickup with prayer times in mind.","Provide hotel details for precise pickup.","Book in advance to secure large vehicles for groups."].map((tip, i) => (
            ...
            <section className="section-padding bg-white">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"How long does the journey take?","answer":"The drive takes roughly 4.5 to 5.5 hours depending on traffic."},{"question":"Can pickup be arranged for Umrah travelers?","answer":"Yes, door-to-door service is provided from your hotel."},{"question":"Can groups travel together?","answer":"Certainly, we accommodate large families and tour groups."}]} title="Frequently Asked Questions" />
                </div>
            </section>
