...
export const metadata: Metadata = {
    title: 'Hajj Taxi: Arafat To Muzdalifah | Pre-Booked Transfer Service',
    description: 'Book a professional Hajj taxi for the Arafat To Muzdalifah route. We provide safe, pre-booked 24/7 transportation with professional chauffeurs for pilgrims during Hajj.',
    openGraph: {
        title: 'Hajj Taxi: Arafat To Muzdalifah | Pre-Booked Transfer Service',
        description: 'Book a professional Hajj taxi for the Arafat To Muzdalifah route. We provide safe, pre-booked 24/7 transportation with professional chauffeurs for pilgrims during Hajj.',
        url: 'https://airporttraveltaxis.com/hajj-taxi-arafat-to-muzdalifah',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/hajj-taxi-arafat-to-muzdalifah',
    },
};
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Hajj Taxi from Arafat to Muzdalifah</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h1 className="font-display text-4xl lg:text-5xl text-surface-900 mb-6 leading-tight">
                                Hajj Taxi from Arafat to <span className="text-primary-600">Muzdalifah</span>
                            </h1>
                            ...
                            <p className="text-surface-600 text-lg leading-relaxed mb-6">
                                Pre-booked transfer from Arafat to Muzdalifah for Hajj travelers.
                            </p>
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-8">
                                <div className="bg-white border border-surface-200 rounded-2xl p-5 shadow-sm">
                                    ...
                                    <p className="text-surface-900 font-semibold">9 km</p>
                                </div>
                                <div className="bg-white border border-surface-200 rounded-2xl p-5 shadow-sm">
                                    ...
                                    <p className="text-surface-900 font-semibold">40-120 minutes</p>
                                </div>
                            </div>
                        </div>
            ...
            <section className="section-padding bg-white border-y border-surface-200">
                <div className="container-custom mx-auto max-w-4xl text-center">
                    ...
                    <p className="text-surface-600 text-lg leading-relaxed">
                        The transit between Arafat and Muzdalifah requires specific coordination. We provide pre-booked transportation for this segment, ensuring a dedicated vehicle is assigned to your group. This eliminates the uncertainty of finding transport on the day.
                    </p>
                </div>
            </section>
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {["Meeting the driver at the pre-arranged holding point in Arafat.","Efficient boarding process for the group.","Travel along the authorized routes to Muzdalifah.","Drop-off at the designated pilgrim areas."].map((step, i) => (
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="bg-white border border-surface-200 rounded-[32px] overflow-hidden shadow-sm">
                        ...
                        <div className="p-8 grid sm:grid-cols-2 gap-6">
                            {["Confirm pickup points precisely, as the area is large.","Allow extra travel time due to traffic.","Ensure all group members are present before the vehicle departs.","Keep your identification and documents accessible."].map((tip, i) => (
            ...
            <section className="section-padding bg-white">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"How do pilgrims travel between Hajj locations?","answer":"Travel is managed through pre-arranged vehicles to ensure order."},{"question":"Can groups travel together?","answer":"Yes, large groups are accommodated in our buses and minibuses."},{"question":"Is the service pre-booked only?","answer":"Yes, all Hajj transportation must be reserved and scheduled in advance."}]} title="Frequently Asked Questions" />
                </div>
            </section>
