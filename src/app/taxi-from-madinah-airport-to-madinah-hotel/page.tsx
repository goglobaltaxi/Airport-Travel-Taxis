...
export const metadata: Metadata = {
    title: 'Taxi from Madinah Airport to Madinah Hotel | Book Online',
    description: 'Book a professional taxi from Madinah Airport to Madinah Hotel. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
    openGraph: {
        title: 'Taxi from Madinah Airport to Madinah Hotel | Book Online',
        description: 'Book a professional taxi from Madinah Airport to Madinah Hotel. We provide safe, pre-booked 24/7 transportation with professional chauffeurs across the GCC countries.',
        url: 'https://airporttraveltaxis.com/taxi-from-madinah-airport-to-madinah-hotel',
    },
    alternates: {
        canonical: 'https://airporttraveltaxis.com/taxi-from-madinah-airport-to-madinah-hotel',
    },
};
        ...
        <div className="pt-20">
            ...
            <section className="section-padding bg-surface-100">
                <div className="container-custom mx-auto">
                    <div className="flex items-center gap-2 text-sm text-surface-500 mb-6 font-medium">
                        ...
                        <span className="text-surface-900 truncate">Taxi from Madinah Airport to Madinah Hotel</span>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <h1 className="font-display text-4xl lg:text-5xl text-surface-900 mb-6 leading-tight">
                                Taxi from Madinah Airport to <span className="text-primary-600">Madinah Hotel</span>
                            </h1>
                            ...
                            <p className="text-surface-600 text-lg leading-relaxed mb-6">
                                Professional transfer from Madinah Airport to your Madinah Hotel. Efficient pre-booked transportation for arriving pilgrims. Our service ensures a safe, direct, and factual transfer without any hidden surprises.
                            </p>
            ...
            <section className="section-padding bg-white border-y border-surface-200">
                <div className="container-custom mx-auto max-w-4xl text-center">
                    ...
                    <p className="text-surface-600 text-lg leading-relaxed">
                        The journey from Madinah Airport to Madinah Hotel covers approximately 20 km. 
            ...
            <section className="section-padding bg-surface-50">
                <div className="container-custom mx-auto">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {["Meet your driver at the arrivals hall in Madinah Airport.","Assistance with your suitcases.","Short transfer directly to your hotel.","Drop-off at the hotel entrance."].map((step, i) => (
                ...
                <div className="container-custom mx-auto max-w-4xl">
                    <div className="bg-white border border-surface-200 rounded-[32px] overflow-hidden shadow-sm">
                        ...
                        <div className="p-8 grid sm:grid-cols-2 gap-6">
                            {["Share your flight details for arrival tracking.","Confirm your exact hotel name to the driver.","Meet the driver at the designated arrivals area."].map((tip, i) => (
            ...
            <section className="section-padding bg-white">
                <div className="container-custom mx-auto max-w-3xl">
                    <FAQ items={[{"question":"How long does the journey take?","answer":"The journey typically takes 25 to 35 minutes."},{"question":"Can airport pickup be arranged for Umrah travelers?","answer":"Yes, we offer direct pickup from the airport to your hotel."},{"question":"Can groups travel together?","answer":"Yes, we provide vehicles that can fit groups and their luggage."}]} title="Frequently Asked Questions" />
                </div>
            </section>
