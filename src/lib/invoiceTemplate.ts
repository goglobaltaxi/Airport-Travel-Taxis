...
<div class="wrapper">
    ...
    <div class="inner"><div class="body">
        ...
        <a href="https://wa.me/966575806733" class="whatsapp-btn">💬 Contact Us on WhatsApp</a>
    </div></div>
    <div class="footer">
...
<div class="wrapper">
    ...
    <div class="inner"><div class="body">
        ...
        <a href="https://wa.me/966575806733?text=${encodeURIComponent(`Hi, I'd like to confirm booking ${data.booking_ref} — ${data.pickup_location} to ${data.dropoff_location} on ${data.pickup_date}`)}" class="whatsapp-btn">✅ Accept & Confirm via WhatsApp</a>
    </div></div>
    <div class="footer">
        <p><strong>${BRAND.name}</strong><br>
        ${BRAND.website} | ${BRAND.email}<br>
