                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 lg:gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <a href="https://wa.me/966575806733" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-surface-300 hover:text-primary-400 transition-colors">
                            ...
                            <li>
                                <a href="tel:+966575806733" className="flex items-center gap-2 text-sm text-surface-300 hover:text-primary-400 transition-colors">
                                    📞 +966 57 580 6733
                                </a>
                            </li>
                            <li>
                    ...
                    <div className="lg:col-span-2">
                        <div className="flex items-center gap-4 bg-primary-600 rounded-2xl p-4">
                            <div className="bg-white rounded-xl p-1.5 shrink-0">
                                <img
                                    src="https://api.qrserver.com/v1/create-qr-code/?size=112x112&margin=0&data=https://wa.me/966575806733"
                            ...
                            <div>
                                ...
                                <a href="https://wa.me/966575806733" target="_blank" rel="noopener noreferrer" className="text-primary-100 text-xs font-semibold hover:text-white transition-colors">
                                    Or tap to chat now →
                                </a>
                            </div>
                        </div>
